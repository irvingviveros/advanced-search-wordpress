...
<button class="tablinks" id="guaven_woos_tablink_analytics" onclick="window.location.href='?page=woo-search-box%2Fadmin%2Fclass-search-analytics.php';return false;"><?php _e('Search Analytics','guaven_woo_search');?></button>
