(function($){
  ...
  function guaven_woos_finish_rendering(){
    ...
    if (typeof guaven_woos_display_in == "undefined") {
      ...
      let gws_final_html_parts=[guaven_woos_cfinalresult , "<ul id=\"751\" class=\"guaven_woos_final_results\">" , guaven_woos_finalresult , guaven_show_all , "</ul>"];
    ...
    jQuery('.guaven_woos_suggestion').html(finalUpdate);
    ...
    if (guaven_woos.shownotfound != '' && guaven_woos_finalresult == '' && guaven_woos_cfinalresult == '') {
      jQuery('.guaven_woos_suggestion').html("<ul  id=\"766\" class=\"guaven_woos_final_results\"><li>" + guaven_woos.shownotfound + "</li></ul>");
