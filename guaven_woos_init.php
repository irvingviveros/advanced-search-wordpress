...
class Guaven_Woos_Init {
    public function __construct(){   
        ...
        if (empty($guaven_woo_search_admin->guaven_woos_firstrun) and $guaven_woo_search_admin->woo_activeness == 1) {
            ...
            add_action('wp_ajax_guaven_woos_tracker', array($guaven_woo_search_analytics,'guaven_woos_tracker_callback'));
            add_action('wp_ajax_nopriv_guaven_woos_tracker', array($guaven_woo_search_analytics,'guaven_woos_tracker_callback'));
